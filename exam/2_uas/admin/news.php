...
<head>
  ...
  <title>E-Sambongrejo | News</title>
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form method="POST" action="controllers/create_update_news.php">
                  <div class="row">
                    ...
                    <div class="col-md-12 mb-12">
                      <div class="form-group row">
                        <div class="col-sm-12">
                          <label>Content</label>
                          <textarea required type="text" name="content" id="content" class="form-control" rows="10"></textarea>
                        </div>
                      </div>
                    </div>
                  ...
                  <?php
                    while ($data = mysqli_fetch_array($query)) {
                      ...
                      echo "<td style='text-align: center'>
                            ...
                            <a href='controllers/delete_news.php?id=".$data['id']."' style='color: red'><i class='fas fa-trash'></i></a>
                          </td>";    
                      echo "</tr>";
                    }
                  ?>
...
<script type="text/javascript">
  ...
  function setEditData(data){
    const {id, title, category, image, content, source} = data;
