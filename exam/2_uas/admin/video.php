<?php
  ...
  // Get data
  $query = mysqli_query($connection, "SELECT * FROM video");
  $no = 0;
?>
...
<head>
  ...
  <title>E-Sambongrejo | Video</title>
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form method="POST" action="controllers/create_update_video.php">
                  <div class="row">
                    ...
                    <div class="col-md-4 mb-4">
                      <div class="form-group row">
                        <div class="col-sm-12">
                          ...
                          <input required type="vid_id" name="vid_id" id="vid_id" class="form-control">
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                    while ($data = mysqli_fetch_array($query)) {
                      ...
                      echo "<td>https://www.youtube.com/embed/".$data['vid_id']."</td>";
                      ...
                      echo "<td style='text-align: center'>
                            ...
                            <a href='controllers/delete_video.php?id=".$data['id']."' style='color: red'><i class='fas fa-trash'></i></a>
                          </td>";    
                      echo "</tr>";
                    }
                  ?>
...
<script type="text/javascript">
  ...
  function setEditData(data){
    const {id, title, vid_id} = data;
    const id_input = document.getElementById('id');
    const title_input = document.getElementById('title');
    const vid_id_input = document.getElementById('vid_id');
    document.getElementById("txth3").innerHTML = "Edit";

    console.log(data);
    id_input.value = id;
    title_input.value = title;
    vid_id_input.value = vid_id;
  }
</script>
</body>
</html>
