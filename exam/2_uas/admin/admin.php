...
<head>
  ...
  <title>E-Sambongrejo | Admin</title>
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form method="POST" action="controllers/create_update_admin.php">
                  <div class="row">
                  ...
                  <?php
                    while ($data = mysqli_fetch_array($query)) {
                      ...
                      echo "<td style='text-align: center'>
                            ...
                            <a href='controllers/delete_admin.php?id=".$data['id']."' style='color: red'><i class='fas fa-trash'></i></a>
                          </td>";    
                      echo "</tr>";
                    }
                  ?>
